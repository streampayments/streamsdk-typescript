...
# Test imports
node -e "const { Checkout, Webhooks } = require('@streampayments/stream-sdk/express'); console.log('✅ CJS import works')"

node -e "import('@streampayments/stream-sdk/express').then(m => console.log('✅ ESM import works'))"
```
...
import type { CheckoutConfig, WebhookConfig } from '@streampayments/stream-sdk/express';
